...
public class UserMailCopyMailCommander extends UserDomainCommander {

	public UserMailCopyMailCommander(CmdConnHandler connHandler) {
		super(connHandler);
	...
	protected byte[] doCmd(String username, String domain, String tail)
		...
		getUsMailAccessorLocal(username, domain).mailCopyMail(
