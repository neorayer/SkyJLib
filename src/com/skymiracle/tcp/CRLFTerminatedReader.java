 ...
 * CRLF. Extends BufferedReader and overrides its readLine() method. The
 * BufferedReader readLine() method cannot serve for SMTP because it ends lines
 * with either CR or LF alone.
 */
public class CRLFTerminatedReader extends BufferedReader {

	public class TerminationException extends IOException {

		private static final long serialVersionUID = -952470747371095419L;
	...
	private static final int EOF = -1, CR = 13, LF = 10;
	...
	public String readLine() throws IOException {
		...
		while (true) {
			...
			if (!cr_just_received) {
				...
				// "\"bare\" CR or LF in data stream pos=" + pos, pos);
				// }
