...
public class OlympusMakernoteDirectory extends Directory {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6232371679471220968L;
	...
	static {
		...
		tagNameMap.put(new Integer(TAG_OLYMPUS_UNKNOWN_1),
				"Makernote Unknown 1");
		tagNameMap.put(new Integer(TAG_OLYMPUS_DIGI_ZOOM_RATIO),
				"DigiZoom Ratio");
		tagNameMap.put(new Integer(TAG_OLYMPUS_UNKNOWN_2),
				"Makernote Unknown 2");
		tagNameMap.put(new Integer(TAG_OLYMPUS_UNKNOWN_3),
				"Makernote Unknown 3");
