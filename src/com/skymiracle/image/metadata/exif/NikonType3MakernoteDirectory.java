...
/**
 * The type-3 directory is for D-Series cameras such as the D1 and D100. Thanks
 * to Fabrizio Giudici for publishing his reverse-engineering of the D1
...
public class NikonType3MakernoteDirectory extends Directory {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9069686811994355137L;
	...
	/**
	 * Values observed - 0100 '~e3
	 */
	public static final int TAG_NIKON_TYPE3_UNKNOWN_12 = 151;

	/**
	 * Values observed - 0100fht@7b,4x,D"Y
	 */
	...
	static {
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_FIRMWARE_VERSION),
				"Firmware Version");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_ISO_1), "ISO");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_FILE_FORMAT), "File Format");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_CAMERA_WHITE_BALANCE),
				"White Balance");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_CAMERA_SHARPENING),
				"Sharpening");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_AF_TYPE), "AF Type");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_CAMERA_WHITE_BALANCE_FINE),
				"White Balance Fine");
		tagNameMap.put(new Integer(
				TAG_NIKON_TYPE3_CAMERA_WHITE_BALANCE_RB_COEFF),
				"White Balance RB Coefficients");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_ISO_2), "ISO");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_CAMERA_TONE_COMPENSATION),
				"Tone Compensation");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_LENS), "Lens");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_CAMERA_COLOR_MODE),
				"Colour Mode");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_CAMERA_HUE_ADJUSTMENT),
				"Camera Hue Adjustment");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_NOISE_REDUCTION),
				"Noise Reduction");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE3_CAPTURE_EDITOR_DATA),
				"Capture Editor Data");
