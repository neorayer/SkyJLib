...
public class ExifDirectory extends Directory {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3033733429483572644L;
	...
	static {
		...
		tagNameMap.put(new Integer(TAG_YCBCR_COEFFICIENTS),
				"YCbCr Coefficients");
		tagNameMap
				.put(new Integer(TAG_YCBCR_SUBSAMPLING), "YCbCr Sub-Sampling");
		...
		tagNameMap
				.put(new Integer(TAG_DATETIME_ORIGINAL), "Date/Time Original");
