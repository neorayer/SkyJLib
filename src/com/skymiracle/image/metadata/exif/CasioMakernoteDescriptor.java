...
public class CasioMakernoteDescriptor extends TagDescriptor {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2649534138857207414L;
	...
	private String getCcdSensitivityDescription() throws MetadataException {
		...
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_CCD_SENSITIVITY);
		switch (value) {
	...
	private String getSaturationDescription() throws MetadataException {
		if (!this._directory
			...
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_SATURATION);
		switch (value) {
		case 0:
			return "Normal";
		case 1:
	...
	private String getContrastDescription() throws MetadataException {
		if (!this._directory
			...
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_CONTRAST);
		switch (value) {
		case 0:
			return "Normal";
		case 1:
	...
	private String getSharpnessDescription() throws MetadataException {
		if (!this._directory
			...
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_SHARPNESS);
		switch (value) {
		case 0:
			return "Normal";
		case 1:
	...
	private String getDigitalZoomDescription() throws MetadataException {
		if (!this._directory
			...
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_DIGITAL_ZOOM);
		switch (value) {
		case 65536:
	...
	private String getWhiteBalanceDescription() throws MetadataException {
		if (!this._directory
			...
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_WHITE_BALANCE);
		switch (value) {
		case 1:
			return "Auto";
		case 2:
	...
	private String getObjectDistanceDescription() throws MetadataException {
		if (!this._directory
			...
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_OBJECT_DISTANCE);
		return value + "mm";
	}
	...
	private String getFlashIntensityDescription() throws MetadataException {
		if (!this._directory
			...
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_FLASH_INTENSITY);
		switch (value) {
		case 11:
			return "Weak";
		case 13:
	...
	private String getFlashModeDescription() throws MetadataException {
		if (!this._directory
			...
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_FLASH_MODE);
		switch (value) {
		case 1:
			return "Auto";
		case 2:
	...
	private String getFocusingModeDescription() throws MetadataException {
		if (!this._directory
			...
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_FOCUSING_MODE);
		switch (value) {
		case 2:
			return "Macro";
		case 3:
	...
	private String getQualityDescription() throws MetadataException {
		if (!this._directory
				.containsTag(CasioMakernoteDirectory.TAG_CASIO_QUALITY))
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_QUALITY);
		switch (value) {
		case 1:
			return "Economy";
		case 2:
	...
	private String getRecordingModeDescription() throws MetadataException {
		if (!this._directory
			...
			return null;
		int value = this._directory
				.getInt(CasioMakernoteDirectory.TAG_CASIO_RECORDING_MODE);
		switch (value) {
		case 1:
