...
public class NikonType2MakernoteDirectory extends Directory {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1531683577788808990L;
	...
	static {
		...
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_AF_FOCUS_POSITION),
				"AF Focus Position");
		...
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_DIGITAL_ZOOM),
				"Digital Zoom");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_FLASH_SETTING),
				"Flash Setting");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_FOCUS_MODE), "Focus Mode");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_IMAGE_ADJUSTMENT),
				"Image Adjustment");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_IMAGE_SHARPENING),
				"Image Sharpening");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_ISO_SELECTION),
				"ISO Selection");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_ISO_SETTING), "ISO Setting");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_MANUAL_FOCUS_DISTANCE),
				"Focus Distance");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_QUALITY), "Quality");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_UNKNOWN_1),
				"Makernote Unknown 1");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_UNKNOWN_2),
				"Makernote Unknown 2");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE2_WHITE_BALANCE),
				"White Balance");
	}
