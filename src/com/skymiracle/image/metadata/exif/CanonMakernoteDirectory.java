...
public class CanonMakernoteDirectory extends Directory {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5942534847597917225L;
	...
	static {
		tagNameMap.put(new Integer(TAG_CANON_FIRMWARE_VERSION),
				"Firmware Version");
		...
		tagNameMap.put(new Integer(TAG_CANON_CUSTOM_FUNCTIONS),
				"Custom Functions");
		tagNameMap.put(new Integer(TAG_CANON_SERIAL_NUMBER),
				"Camera Serial Number");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_AF_POINT_SELECTED),
				"AF Point Selected");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_CONTINUOUS_DRIVE_MODE),
				"Continuous Drive Mode");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_CONTRAST), "Contrast");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_EASY_SHOOTING_MODE),
				"Easy Shooting Mode");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_EXPOSURE_MODE),
				"Exposure Mode");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_FLASH_DETAILS),
				"Flash Details");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_FLASH_MODE), "Flash Mode");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_FOCAL_UNITS_PER_MM),
				"Focal Units per mm");
		tagNameMap
				.put(new Integer(TAG_CANON_STATE1_FOCUS_MODE_1), "Focus Mode");
		tagNameMap
				.put(new Integer(TAG_CANON_STATE1_FOCUS_MODE_2), "Focus Mode");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_IMAGE_SIZE), "Image Size");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_ISO), "Iso");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_LONG_FOCAL_LENGTH),
				"Long Focal Length");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_MACRO_MODE), "Macro Mode");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_METERING_MODE),
				"Metering Mode");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_SATURATION), "Saturation");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_SELF_TIMER_DELAY),
				"Self Timer Delay");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_SHARPNESS), "Sharpness");
		tagNameMap.put(new Integer(TAG_CANON_STATE1_SHORT_FOCAL_LENGTH),
				"Short Focal Length");
		/*
		 * tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_1), "Unknown Camera State
		 * 1"); tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_2), "Unknown Camera
		 * State 2"); tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_3), "Unknown
		 * Camera State 3"); tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_4),
		 * "Unknown Camera State 4"); tagNameMap.put(new
		 * Integer(TAG_CANON_STATE1_UNKNOWN_5), "Unknown Camera State 5");
		 * tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_6), "Unknown Camera State
		 * 6"); tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_7), "Unknown Camera
		 * State 7"); tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_8), "Unknown
		 * Camera State 8"); tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_9),
		 * "Unknown Camera State 9"); tagNameMap.put(new
		 * Integer(TAG_CANON_STATE1_UNKNOWN_10), "Unknown Camera State 10");
		 * tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_11), "Unknown Camera
		 * State 11"); tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_12), "Unknown
		 * Camera State 12"); tagNameMap.put(new Integer(TAG_CANON_STATE1_UNKNOWN_13),
		 * "Unknown Camera State 13");
		 */

		tagNameMap.put(new Integer(TAG_CANON_STATE2_WHITE_BALANCE),
				"White Balance");
		tagNameMap.put(new Integer(TAG_CANON_STATE2_SEQUENCE_NUMBER),
				"Sequence Number");
		tagNameMap.put(new Integer(TAG_CANON_STATE2_AF_POINT_USED),
				"AF Point Used");
		tagNameMap.put(new Integer(TAG_CANON_STATE2_FLASH_BIAS), "Flash Bias");
		tagNameMap.put(new Integer(TAG_CANON_STATE2_SUBJECT_DISTANCE),
				"Subject Distance");
	}
