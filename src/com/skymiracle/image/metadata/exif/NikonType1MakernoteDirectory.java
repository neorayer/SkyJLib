...
public class NikonType1MakernoteDirectory extends Directory {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 679280274826818939L;
	...
	static {
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_CCD_SENSITIVITY),
				"CCD Sensitivity");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_COLOR_MODE), "Color Mode");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_DIGITAL_ZOOM),
				"Digital Zoom");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_CONVERTER),
				"Fisheye Converter");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_FOCUS), "Focus");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_IMAGE_ADJUSTMENT),
				"Image Adjustment");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_QUALITY), "Quality");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_UNKNOWN_1),
				"Makernote Unknown 1");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_UNKNOWN_2),
				"Makernote Unknown 2");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_UNKNOWN_3),
				"Makernote Unknown 3");
		tagNameMap.put(new Integer(TAG_NIKON_TYPE1_WHITE_BALANCE),
				"White Balance");
	}
