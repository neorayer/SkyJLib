 ...
 * basic metadata about the image. Date: Aug 2, 2003
 * 
...
public class JpegDirectory extends Directory {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7397048127726255271L;
	/**
	...
	/**
	 * The image's width. Necessary for decoding the image, so it should always
	 * be there.
	 */
	...
	/**
	 * the first of a possible 4 color components. Number of components
	 * specified in TAG_JPEG_NUMBER_OF_COMPONENTS.
	 */
	public static final int TAG_JPEG_COMPONENT_DATA_1 = 6;
	/**
	 * the second of a possible 4 color components. Number of components
	 * specified in TAG_JPEG_NUMBER_OF_COMPONENTS.
	 */
	public static final int TAG_JPEG_COMPONENT_DATA_2 = 7;
	/**
	 * the third of a possible 4 color components. Number of components
	 * specified in TAG_JPEG_NUMBER_OF_COMPONENTS.
	 */
	public static final int TAG_JPEG_COMPONENT_DATA_3 = 8;
	/**
	 * the fourth of a possible 4 color components. Number of components
	 * specified in TAG_JPEG_NUMBER_OF_COMPONENTS.
	 */
	 ...
	 *            between 0 and 3. Use getNumberOfComponents for
	 *            bounds-checking.
	 * @return
	 */
