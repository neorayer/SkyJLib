...
//		System.out.println(new String(Base64.decode(""), "UTF-8"));
//		System.out.print(new String(Base64.encode("ou=河南省监狱管理局".getBytes("UTF-8")), "ASCII"));
		
//		String date = CalendarUtil.getLocalDateTime();
//		String ip = "127.0.0.1";
//		// 加密
//		String ticket = new String(Base64.encode((date + "::::" + ip).getBytes("UTF-8")), "ASCII");
//		System.out.println(ticket);
//		// 解密
//		String str = new String(Base64.decode(ticket), "UTF-8");
//		System.out.println(str);
		
		
		String a = new String(Base64.decode(""), "gb2312");
