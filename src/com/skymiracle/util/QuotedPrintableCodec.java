 ...
 * 
 * printable characters in the ASCII character set. It encodes the data in such
 * a way that the resulting octets are
 * 
 ...
 * 
 * does not lend itself well into the byte[] oriented codec framework. Complete
 * the codec once the steamable codec
 * 
...
public class QuotedPrintableCodec {
		...
		for (int i = 0; i < bytes.length; i++) {
			...
			if (b == ESCAPE_CHAR) {
				...
				try {
					...
					if (u == -1 || l == -1) {
						// throw new Exception("Invalid quoted-printable
						// encoding");
					} else
	...
	public static final byte[] decodeQuotedPrintable(byte[] bytes, int begin,
	...
	public byte[] decode(byte[] bytes, int begin, int end) throws Exception {
		return decodeQuotedPrintable(bytes, begin, end);
	}
	...
	public String decode(String pString, String charset) throws Exception,
		...
		return new String(decode(pString.getBytes("ISO-8859-1")), charset);
	 ...
	 * @throws Exception
	 * 
	 * Thrown if quoted-printable encoding is not applicable to objects of this
	 * type or if encoding is
	 * 
	 * unsuccessful
	 * 
	 */
	...
	public Object encode(Object pObject) throws Exception {
		...
		if (pObject == null) {
			...
			throw new Exception("Objects of type "
	 ...
	 * @throws Exception
	 * 
	 * Thrown if quoted-printable decoding is not applicable to objects of this
	 * type if decoding is
	 * 
	 * unsuccessful
	 * 
	...
	public String encode(String pString, String charset)
		...
		return new String(encode(pString.getBytes(charset)), "ISO-8859-1");

	}

	public static void main(String[] args) throws Exception {
		String s = "=D2=BB=D0=A9=C5=F3=D3=D1=CC=D6=C2=DB=B9=FD=A3=AC=D2=BB=D6=C2=C8=CF=CE=AA=CA=C7=";
		System.out.println(new QuotedPrintableCodec("gb2312").decode(s));
	}
}
