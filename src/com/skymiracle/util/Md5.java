...
public class Md5 {
	...
	/**
	 * use to pad the input data,if data%512 != 448, pad the data
	 */
	...
	private byte[] end() {
		...
		for (int i = 0; i < 8; i++)
			bits[i] = (byte) ((this.count >>> (i * 8)) & 0xff);
		int index = ((int) (this.count >> 3)) & 0x3f;
	...
	public static void main(String args[]) throws IOException {
		// if (args.length != 1) {
		// System.out.print("Md5 <file>\r\n");
		// System.exit(1);
		// }
		// Md5 md5 = new Md5(new FileInputStream(new File(args[0])));
		// byte b[] = md5.getDigest();
		// System.out.print(stringify(b) + "\r\n");

		Md5 md5 = new Md5("111111", "utf-8");
		md5.getDigest();
