...
public class ExcelCSVParser implements CSVParse {
	 ...
	 */
	public ExcelCSVParser(InputStream in, char delimiter, String charset)
			throws BadDelimiterException, UnsupportedEncodingException {
		this.inStream = in;
		this.lexer = new ExcelCSVLexer(in, charset);
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public ExcelCSVParser(InputStream in, String charset) throws UnsupportedEncodingException {
		this.inStream = in;
		this.lexer = new ExcelCSVLexer(in, charset);
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			ExcelCSVParser p = new ExcelCSVParser(in, "ISO-8859-1");
			String[] t;
