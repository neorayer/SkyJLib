...
public class SkyUpFile {
	private SkyUpload m_parent;
	...
	public void saveAs(String s) throws IOException, SkyUploadException {
		saveAs(s, 0);
	}

	public void saveAs(String s, int i) throws IOException, SkyUploadException {
		...
		try {
			...
			throw new SkyUploadException("File can't be saved (1120).");
		}
	}
	...
	protected void setParent(SkyUpload smartupload) {
